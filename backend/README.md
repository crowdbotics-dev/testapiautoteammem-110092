...
## Project Structure
    ...
    ├── testapiautoteammem_110092  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammem_110092`
...
2. Clone this repo and `cd testapiautoteammem_110092`
